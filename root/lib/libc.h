...
// int vsprintf(char *s, char *f, __va_list v)
// {
...
// int sprintf(char *s, char *f, ...) { __va_list v; va_start(v, f); return vsprintf(s, f, v); }
// int printf(char *f, ...) { char s[BUFSIZ]; __va_list v; va_start(v, f); return write(1, s, vsprintf(s, f, v)); }
// int vprintf(char *f, __va_list v) { char s[BUFSIZ]; return write(1, s, vsprintf(s, f, v)); }
// int dprintf(int d, char *f, ...) { char s[BUFSIZ]; __va_list v; va_start(v, f); return write(d, s, vsprintf(s, f, v)); }
// int vdprintf(int d, char *f, __va_list v) { char s[BUFSIZ]; return write(d, s, vsprintf(s, f, v)); }
